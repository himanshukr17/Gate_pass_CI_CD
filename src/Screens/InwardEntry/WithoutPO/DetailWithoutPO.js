...
function DetailWithoutPO() {
      ...
      // Fixed: now accepts and forwards `index`, so the selected plant is
      // written onto the correct item in `everyitemdata` instead of being
      // silently dropped onto a stray `data[undefined]` property.
      const handleChange = (event, index) => {
            setvalue({ PLANT: event.target.value }, index)
      }
      ...
      const setvalue = (val, index) => {
            setdata((prevData) => {
                ...
                if (index === undefined || index >= data.length || !data[index]) {
      ...
      return (
            <>
                  ...
                  {everyitemdata.map((count, index) => {
                        return (
                              <div className='InputBox1' key={index}>
                                          ...
                                          <div className='grid-container'>
                                                <div className='inputFeildDesign'>
                                                      ...
                                                      <input
                                                            ...
                                                            value={everyitemdata[index]?.MATERIAL_DESC || ""}
                                                ...
                                                <div className='inputFeildDesign'>
                                                      ...
                                                      <input
                                                            ...
                                                            value={everyitemdata[index]?.VENDOR_NAME || ""}
                                          ...
                                          <div className='grid-container'>
                                                <div className='inputFeildDesign'>
                                                      ...
                                                      <select
                                                            ...
                                                            className="form-control"
                                                            value={everyitemdata[index]?.PLANT || ""}
                                                ...
                                                <div className='inputFeildDesign'>
                                                      ...
                                                      <input
                                                            ...
                                                            value={everyitemdata[index]?.QUANTITY || ""}
                  ...
                  <div className='Reviewbutton'>
                        <button className="ReviewbuttonStyle" onClick={() => navigate('/Inward/WithoutPO/ItemFeilds', { state: { previousdata, everyitemdata } })}>
                              View Item Fields
                        </button>
                  </div>
