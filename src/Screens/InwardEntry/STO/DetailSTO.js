...
function DetailSTO(props) {
      ...
      console.log("seleeeected Po-data", podata);
      const [data, setdata] = useState({
        INVOICE: podata.SelectedGateEntry.INVOICE_NO,
        DOCDATE: podata.SelectedGateEntry?.DOCUMENT_DATE,
        VENDORNAME: podata.SelectedGateEntry?.VENDOR_NAME,
        DRIVERNAME: podata.SelectedGateEntry?.DRIVER_NAME,
        MOBILE: podata.SelectedGateEntry?.MOBILE_NUMBER,
        MOT: podata.SelectedGateEntry?.MODE_OF_TRANSPORT,
        VEHICLENO: podata.SelectedGateEntry?.VEHICLE_NO,
        VEHCAT: podata.SelectedGateEntry?.VEHICLE_CATEGORY,
        ROADPERMIT: podata.SelectedGateEntry?.ROAD_PERMIT_NUMBER,
        LR: podata.SelectedGateEntry?.LR_NO,
        LRDATE: podata.SelectedGateEntry?.LR_DATE,
        PACKAGES: podata.SelectedGateEntry?.PACKAGES,
        VEHICLEREPDATE: podata.SelectedGateEntry?.REPORTING_DATETIME,
        ...
        if (vehicles.length > 0) {
          const newData = {
            ...
            VEHICLEREPDATE: vehicles[0]?.VEHICLE_REPORTING_TIME
              ? new Date(vehicles[0]?.VEHICLE_REPORTING_TIME).toISOString().slice(0, 16)
              : data.VEHICLEREPDATE,
      ...
      const handleSubmit = () => {
        ...
        if (hasErr) {
          ...
          navigate("/Inward/STO/ItemFeildSTO", {
      ...
      console.log("LR",podata?.SelectedGateEntry?.LR_NO)
              ...
              <div className="row">
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    value={podata?.SelectedGateEntry?.VEHICLE_NO
                    }
                ...
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    value={podata?.SelectedGateEntry?.ROAD_PERMIT_NUMBER}
              ...
              <div className="row">
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <select
                    ...
                    value={podata?.SelectedGateEntry?.MODE_OF_TRANSPORT}
                ...
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <select
                    ...
                    value={podata?.SelectedGateEntry?.VEHICLE_CATEGORY}
              ...
              <div className="row">
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    disabled
                    value={podata?.SelectedGateEntry?.INVOICE_NO}
                    // disabled
                ...
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    value={moment(podata.SelectedGateEntry?.DOCUMENT_DATE).format("YYYY-MM-DD")}
              ...
              <div className="row">
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    value={podata?.SelectedGateEntry?.LR_NO}
                ...
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    // value={data.LRDATE}
                    value={moment(podata.SelectedGateEntry?.LR_DATE).format("YYYY-MM-DD")}
              ...
              <div className="row">
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    value={podata?.SelectedGateEntry?.DRIVER_NAME}
                ...
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    // value={data.MOBILE}
                    value={podata?.SelectedGateEntry?.MOBILE_NUMBER}
              ...
              <div className="row">
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    value={new Date(podata?.SelectedGateEntry?.REPORTING_DATETIME).toISOString().slice(0, 16)}
                ...
                <div className="input-group" style={{ paddingRight: "50px" }}>
                  ...
                  <input
                    ...
                    // value={data.PACKAGES}
                    value={podata?.SelectedGateEntry?.PACKAGES}
