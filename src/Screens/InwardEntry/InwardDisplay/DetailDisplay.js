...
function DetailDisplay() {
  ...
  const viewimage = (url) => {
    let imageurl = `${apiURL}images/${url}`
  }
  ...
  const col = (previousdata[0].TYPE == 1 ? [
    {
      Header: "Line Item",
      accessor: "LINE_ITEM"
    },
    ...
    <>
      ...
      <div className='headinggg'>
        <div className='headingStyle'>
         <Link to="/Home" style={{ color: 'black' }}><p>Inward Gate Entry - </p></Link>
          <p className='po'>Display Inward Gate Entry</p>
        </div>
      </div>
      ...
      <div className='InputBox'>
        ...
        <div className='detailStyleee' >
          <p>Invoice Number : </p>
          <p className='detailStyle1'>{previousdata[0].INVOICE_NO}</p>
        </div>
