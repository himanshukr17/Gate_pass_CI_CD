...
function FieldChangeout(props) {
  ...
  const col = (outTimedata.previousdata[0].TYPE == 5 ? [
    {
      Header: "Line Item",
      accessor: "LINE_ITEM"
    },
  ...
  ] : outTimedata.previousdata[0].TYPE == 4 ? [
  ...
  // console.log('====================================');
  // console.log(outTimedata.previousdata[0].GATE_ENTRY_NO);
  // console.log('====================================');
    ...
    <>
      ...
      <div className='InputBox'>
        ...
        <div className='detailStyleee' >
          <p>Invoice Number : </p>
          <p className='detailStyle1'>{outTimedata.previousdata[0].INVOICE_NO}</p>
        </div>
...
export default connect(null, { ChangeData })(FieldChangeout)