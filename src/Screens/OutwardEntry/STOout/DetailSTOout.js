...
function DetailSTOout(props) {
  ...
  const handleSubmit = () => {
    ...
    if (hasErr) {
      ...
      navigate("/Outward/STO/ItemFields", {
...
// export default DetailSTOout

export default connect((mapStateToProps), { getVehicleDetails })(DetailSTOout)