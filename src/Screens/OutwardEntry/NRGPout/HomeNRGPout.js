...
function HomeNRGPout(props) {
      ...
      const handleSubmit = () => {
            ...
            seterror(err)
            if (!hasErr) {
                  props.SalesData({ po: data.PO }).then(response => {
                        if (response.status == 200) {
                              // console.log(response)
                              navigate('/Outward/NRGP/Details', { state: response.data })
                        }
                  }).catch((err) => {
                              ...
                              <div className='rightdiv'>
                                    ...
                                    <div className='rightIcon'>
                                          <div>
                                                ...
                                                <h2 className='h3'>Against Invoice/Challan</h2>
                                          </div>
                                    ...
                                    <div className="inputsSTO">
                                          ...
                                          <div className='grid-container'>
                                                <p className='Stoheading'>Invoice Number</p>
                                                <input
                                                      // class="form-control"
                                                      type="text"
